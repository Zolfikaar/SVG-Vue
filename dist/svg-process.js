...
exports.bboxToViewBox = bboxToViewBox;
exports.parseViewBoxFromSvgRoot = parseViewBoxFromSvgRoot;
exports.optimizeSvg = optimizeSvg;
exports.parseSvgDocument = parseSvgDocument;
exports.serializeSvgInnerContent = serializeSvgInnerContent;
exports.formatRootAttributes = formatRootAttributes;
exports.applyCurrentColorToFills = applyCurrentColorToFills;
const xmldom_1 = require("@xmldom/xmldom");
const svgo_1 = require("svgo");
const svgpath_1 = __importDefault(require("svgpath"));
const svg_path_bbox_1 = require("svg-path-bbox");
...
function elementBBox(el, matrix) {
    ...
    switch (name) {
        case 'path': {
            ...
            try {
                const d2 = new svgpath_1.default(d)
                    .matrix([matrix.a, matrix.b, matrix.c, matrix.d, matrix.e, matrix.f])
                    .round(4)
                    .toString();
                return (0, svg_path_bbox_1.svgPathBbox)(d2);
            }
            catch {
                return null;
            }
...
//# sourceMappingURL=svg-process.js.map